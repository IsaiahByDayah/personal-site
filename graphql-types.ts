...
export type FileFieldsEnum = 
  ...
  | 'childMarkdownRemark___frontmatter___hash'
  ...
  | 'childMarkdownRemark___frontmatter___thumbnail_alt'
...
export type HeaderQuery = { avatar?: Maybe<{ childImageSharp?: Maybe<{ fixed?: Maybe<Pick<ImageSharpFixed, 'src'>> }> }>, site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }> };
...
export type SideNavContentQuery = { avatar?: Maybe<{ childImageSharp?: Maybe<{ fixed?: Maybe<Pick<ImageSharpFixed, 'src'>> }> }>, site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }> };
...
export type Unnamed_2_Query = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, allMarkdownRemark: { edges: Array<{ node: (
        Pick<MarkdownRemark, 'excerpt'>
        & { frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'hash' | 'slug' | 'date' | 'title' | 'description'>> }
      ) }> } };
...
export type IndexPageQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, allMarkdownRemark: { edges: Array<{ node: (
        Pick<MarkdownRemark, 'excerpt'>
        & { frontmatter?: Maybe<(
          Pick<MarkdownRemarkFrontmatter, 'hash' | 'slug' | 'date' | 'title' | 'description' | 'thumbnail_alt'>
          & { thumbnail?: Maybe<{ childImageSharp?: Maybe<{ fixed?: Maybe<Pick<ImageSharpFixed, 'src'>> }> }> }
        )> }
      ) }> } };

export type BlogPostByHashQueryVariables = Exact<{
  hash: Scalars['String'];
}>;


export type BlogPostByHashQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, markdownRemark?: Maybe<(
