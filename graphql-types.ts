...
export type FileFieldsEnum =
  ...
  | 'childrenMdx___frontmatter___hash'
  ...
  | 'childrenMdx___frontmatter___thumbnail_alt'
...
export type BioQuery = { avatar?: Maybe<{ childImageSharp?: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }>, site?: Maybe<{ siteMetadata?: Maybe<{ author?: Maybe<(
...
export type HeaderQuery = { avatar?: Maybe<{ childImageSharp?: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }>, site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }> };
...
export type SideNavContentQuery = { avatar?: Maybe<{ childImageSharp?: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }>, site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }> };

export type SideNavDrawerContentQueryVariables = Exact<{ [key: string]: never; }>;


export type SideNavDrawerContentQuery = { avatar?: Maybe<{ childImageSharp?: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }>, site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }> };

export type IndexPageQueryVariables = Exact<{ [key: string]: never; }>;


export type IndexPageQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, allMdx: { edges: Array<{ node: (
        Pick<Mdx, 'excerpt'>
        & { frontmatter?: Maybe<(
          Pick<MdxFrontmatter, 'hash' | 'slug' | 'date' | 'title' | 'description' | 'thumbnail_alt'>
          & { thumbnail?: Maybe<{ childImageSharp?: Maybe<(
...
export type BlogPostTemplateQuery = { mdx?: Maybe<(
    Pick<Mdx, 'body' | 'excerpt' | 'timeToRead'>
    & { frontmatter?: Maybe<(
      Pick<MdxFrontmatter, 'title' | 'thumbnail_alt' | 'description' | 'date'>
