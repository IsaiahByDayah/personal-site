...
const Page = async () => {
  ...
  const blogroll = await prismic.getSingle("blogroll").catch(() => null)
    ...
    <div className="py-16 sm:py-20">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:max-w-4xl">
          <h2 className="txt-heading text-center">{blogroll?.data.title}</h2>
          <div className="prose txt-prose mt-4 max-w-none text-center text-balance">
            <PrismicRichText field={blogroll?.data.description} />
          </div>
